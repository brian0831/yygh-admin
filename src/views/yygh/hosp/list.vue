  ...
  export default {
    ...
    methods: {
      updateStatus(id, status) {
        ...
        hospApi.updateStatus(id, status).then(resp => {
          ...
          if (resp.code == 20000) {
            ...
            this.fetchData(this.page)  // 当前页重新加载
          }
        })
      },
      //医院列表
      fetchData(page = 1) {
        this.page = page //默认查询第一页
      ...
      resetData() {
        ...
        // this.searchObj = {provinceCode:"xxx",cityCode:"xxx",hosname:'xxxx'}
